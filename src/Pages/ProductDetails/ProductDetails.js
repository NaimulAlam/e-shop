      ...
      <div className="py-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-gray-400 text-sm">
            <a href="/shop" className="hover:underline hover:text-gray-600">
              Shop
            </a>
            <span>\</span>
            <a href="#a" className="hover:underline hover:text-gray-600">
              Electronics
            </a>
            <span>\</span>
          ...
          <div className="flex flex-col md:flex-row -mx-4">
            ...
            <div className="md:flex-1 px-4">
              ...
              <p className="text-gray-500">
                Details: Lorem ipsum, dolor sit, amet consectetur adipisicing elit. Vitae
